  ...
  return (
    <div className="fixed inset-0 bg-purple-900 bg-opacity-50 flex items-center justify-center p-4 z-40">
      <div className="bg-white rounded-lg p-8 max-w-2xl w-full">
        <h2 className="text-2xl font-bold mb-4 text-purple-800">{job.title}</h2>
        <p className="text-purple-600 mb-2">{job.company}</p>
        <p className="text-purple-500 mb-4">{job.location}</p>
        <div className="text-gray-700 mb-6">{job.description}</div>
